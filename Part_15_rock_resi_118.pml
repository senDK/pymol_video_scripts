...
select adjto119, resi 47+119
disable adjto119

show sticks, adjto119
clip far, -20
util.cbak adjto119
disable adjto119
...
_ set_view (\
_     0.672115088,   -0.725897133,    0.145721540,\
_    -0.570319176,   -0.382097423,    0.727111280,\
_    -0.472132832,   -0.571843803,   -0.670845330,\
_    -0.000679161,    0.002653711,  -44.007030487,\
_    26.508550644,   37.574546814,   27.106405258,\
_   -38.427291870,  124.655990601,  -20.000000000 )
mview store
mview reinterpolate
set ray_trace_frames=1
set ray_shadow,off
...
#^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
#part13 move to resi 118 and 117

hide stick, res119
hide cartoon, res119
delete res119
hide stick, adjto119
hide cartoon, adjto119
delete adjto119
...
select res118117, resi 118+117
disable res118117
show sticks, res118117
util.cbag res118117
zoom res118117, buffer=4.0


clip far, -20

select lab, res118117 and name CA
disable lab
label lab,  ("%s, %s") % (resn, resi)
set label_color, white, lab
set label_font_id, 12
...
_ set_view (\
_     0.354222208,   -0.413631409,    0.838651299,\
_    -0.930681765,   -0.243353516,    0.273067772,\
_     0.091161259,   -0.877285957,   -0.471174121,\
_     0.000212267,    0.000735730,  -60.984306335,\
_    28.430717468,   40.652450562,   25.419712067,\
_  -151.501800537,  271.667755127,  -20.000000000 )
